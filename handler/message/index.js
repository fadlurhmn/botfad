...
module.exports = msgHandler = async (client = new Client(), message) => {
    try {
        ...
        case 'facebook':
            ...
            await client.reply(from, '_Scraping Metadata..._ \n\nTerimakasih telah menggunakan bot ini, kamu dapat membantu pengembangan bot ini dengan menyawer melalui DANA : 081389087364 (HAMDAN) atau OVO : 0895396162964 (NUNUNG) \nTerimakasih.', id)
        ...
        case 'everyone':
            ...
            */
            ...
            await client.sendTextWithMentions(from, `heyy, ${pushname} keluar lo semua !!!\n${mentions}`)
            break
        case 'botstat': {
